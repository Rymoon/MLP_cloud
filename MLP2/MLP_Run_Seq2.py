...
"""
Continue train from MLP_Run_Seq
sd-file From:
    MLP_Run_Seq_xxx
        MLP0\\31.sd
        MLP1\\9.sd
...
sd_paths = ["D:\\Workspace\\ADMM_Net\\MyHumbleADMM2\\MLP2\\MLP_Run_Seq_MLP0\\31.sd",
"D:\\Workspace\\ADMM_Net\\MyHumbleADMM2\\MLP2\\MLP_Run_Seq_MLP1\\9.sd",
"D:\\Workspace\\ADMM_Net\\MyHumbleADMM2\\MLP2\\MLP_Run_Seq_MLP2\\8.sd"]
...
for i in range(n_model):
    ...
    task = TrainTask(models[i],train_dataset,test_dataset,logger,dblogger,sz_batch = 64,n_max_epoch=n_max_epoch,n_sample_per_epoch = n_sample_per_epoch,n_epoch_per_save_state_dict=4,startfrom_path=sd_paths[i],runner = runner)
